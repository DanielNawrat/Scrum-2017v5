...
Once the game has started you can always use the built in helper command by simply typing "helper" and you will recieve a list of useful commands that can be used to progress the story.
...
However, it is not recommended to do so since you might miss important parts of the story and therefore not experience the game in its entirety.
