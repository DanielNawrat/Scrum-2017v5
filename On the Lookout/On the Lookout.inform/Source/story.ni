...
Figure of the Landing Zone_Sitis is the file "Sitis1.png".
The room-illustration of Flat Rock_Sitis is the Figure of the Landing Zone_Sitis.
The room-illustration of the Wide Desert_Sitis is the figure of the Landing Zone_Sitis.
The room-illustration of the Rampart of Sicuum_Sitis is the figure of the Landing Zone_Sitis.
...
"Welcome to your journey, [bold type]Axesto[roman type]! You are going to leave your home planet Fidatis for the first time. Isn't it exciting? Finally, you can expercience everything all by yourself. Although you love your home - the wide lush meadows, the different colourful flowers, the clear small seas and specially your family. But it's abou time. You are full-aged now, so you are allowed to leave Fidatis for the first time. And not for anything in the world you would miss this chance. You already know what your first goal will be - the only planet you have been able to see since you are alive. You don't know its name neither anything else... but you know that you've always wanted to travel there. The engine starts, you focuse your view, the spaceship raises - the journey begins."
...
[Räume]
The Wide Desert of Sitis_Sitis is a room. The printed name of the Wide Desert of Sitis_Sitis is "The Wide Desert". The description of the Wide Desert of Sitis_Sitis is "You've reached the Desert of Sitis. It gives you two things: First, an impression of what whole Sitis looks like - sandy, dry, with some deep stone canyons and huge rocks afar. But although this planet does not seem to be a place to life, the Desert also gives you the chance to discern that you are not alone. There IS life! When you look [bold type]north[roman type], directly in front of you is a long corrugated iron bridge, guiding over one of those ravines. You can not access the bridge, it is blocked with a barbed wire fence, but straight ahead, at the end you see a majestic sandstone palace. In the bridge's middel, a wooden ladder leads to an enormous square block in the east. Likewise it is built out of stone and gives a somber impression. If you look [bold type]east[roman type] from the point you are standing at right now, you see the kind of a rock mine. In the [bold type]south[roman type] you recognise a lot of small white houses surrounded by a rampart. It seems like [bold type]people are living here[roman type]."
The Wide Desert of Sitis_Sitis is east of the Flat Rock_Sitis. 

The Rampart around Sicuum_Sitis is a room. The printed name of the Rampart around Sicuum_Sitis is "The Rampart around Sicuum". The Description of the Rampart around Sicuum_Sitis is "This massive wooden rampart seems to protect what- or whoever is living behind. The only way to pass is the gate you see."
...
Instead of going east from the Wide Desert of Sitis_Sitis for the first time:
	say "At the moment, there's nothing that could help you out there. You need humans to be able to continue your journey.";
...
After answering that "Axesto":
	...
	say "First there's silence. Then the gate squeaks and it opens slowly. Right now, [bold type]south[roman type] is still the direction you need to go.";
...
The Agora_Sitis is a room. The printed name of the Agora_Sitis is "The Agora of Sicuum". The Agora_Sitis is south of the wooden gate. The description of the Agora_Sitis is "Brisky bustle dominates this place. People are talking, buying things on the market and kids are playing with each other. No one cares about you. But right in the middle of this huddle, you realize a boy staring at you. He hides a bit behind one of those market booth. His view radiates a mixture of fear and fascination. Maybe you break the ice between you two, if you friendly [bold type]wave at him[roman type]?"
...
After examining Mitéra for the first time:
	...
	say "First, you want to do the same, but then you focuse on Mitéra again. However, she directly signals, you should [bold type]follow Anaidis[roman type]. So, what are you waiting for?[paragraph break]";
	...
	now the description of the Agora_Sitis is "As you arrive at the Agora, it is full of people looking a bit scared. The built a circle around something, you do not see. But anyway, you just wanna know what this Scorpius did. Specially, when you see how people react just while talking about him. So, you need to grind out your way to Anaidis. He's hiding - again - behind one market booth. Luckily you are wo small, you are able to sneak through the crowd of people easily. The boy is totally focused on everything, but you. Even so, you can't wait any longer. Therefore, [bold type]ask him about scorpius[roman type].";
...
After asking Anaidis about "scorpius":
	...
	say "This gladiator Machitikos looks highly dangerous. He is tall, muscular and his sight is totally aggressive. During you stare at him, he's punching the air as he would already stick into a battle. The chance you will beat him seems slightly. Too slightly. But anyhow you feel determined - you really wanna overmatch Machitikos. For yourself and for the repressed Sitisianer.[paragraph break]";
...
After taking a bow in front of Scorpius for the first time:
	...
	say "The people around you start whispering fluttered. Scorpius stares at you incredulously. But then he starts smiling devilishly.[paragraph break]";
	say "[italic type]'So... go on. Have fun, you naive iditot![roman type][paragraph break]";
...
After attacking Machitikos the first time:
	...
	say "[italic type]'You Idiot! Did you really thought you gonna knock me out that easily? Hahahahahaha. Are you megalomaniacal? The best, I kill you right here, right now. Cause you do not deserve to live anymore.'[roman type][paragraph break]";
...
After clawing Machitikos the first time:
	...
	now the description of the Flat Rock_Sitis is "Your journey through Sitis ends here. You've reached your aim - two new water container lay in your spaceship. But above you've met very polite, helpful people that tragically suffer from the reign of a bastard. On the other hand, you experienced them as very optimistic - whatever happens between them and Scorpius - so you are kind of reassured.";
